...
1. Backend code running on AWS Lambda. The main entry point is `./src/server/index.js`. The packaging is controlled by `webpack.server.config.js` and optimized for Node.js 8.10.
...
Personally I love Flow and code all of my project in TypeScript, but have decided against using it in this project for now. There's not much JavaScript code in here anyway so you can use in your own project whatever you prefer.
